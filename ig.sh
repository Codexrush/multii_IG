...
# asking
echo -ne "${white}[ ${red}?${white} ] Masukin PilihanNya Jancuk ${red}:${green} " ; read ask_menu

# select menu
case $ask_menu in
	1 ) # menu 1
		echo -e "\n${white}[ ${red}NOTE${white} ] ${red}:${white} Beri Ruang Untuk Mencari Lebih Dari 1  ${red}[${white} example ${red}:${white} Pengguna1 Pengguna2 ${red}]${white}"
